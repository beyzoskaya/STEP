...
def map_chromosome_data(gene_file, hic_file, chromosome_number, output_file):
    ...
    Parameters:
    gene_file: time series interaction data
    hic_file: Space-separated HiC interaction file (mESC HiC contact maps)
    chromosome_number: convert wanted chromosome
    """
    ...
    for i, gene1 in chrom_genes.iterrows():
        ...
        for j, gene2 in chrom_genes.iterrows():
            ...
            # only get frequencies bigger than 0 to get interactions
            if hic_freq > 0:
                row_data = {
                    'Gene1': gene1_name,
...
if __name__ == "__main__":
    ...
    hic_file = "mESC_1mb_converted/HindIII_mESC.nor.chrX_1mb_contact_map.txt"  
    chromosome_number = "X"         
    output_file = "mapped/chromosome_X_mapped.csv"
