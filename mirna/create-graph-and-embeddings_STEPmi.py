...
class TemporalGraphDatasetMirna:
    def __init__(self, csv_file, embedding_dim=256, seq_len=10, pred_len=1, graph_params=None, node2vec_params=None):
        ...
        print(f"Found {len(self.time_points)} time points") # Found 160 time points
